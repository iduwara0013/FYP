...
public class BuyerController {
    ...
    @PutMapping("/{buyerId}")
    public ResponseEntity<Map<String, Object>> updateBuyer(@PathVariable String buyerId, @Valid @RequestBody BuyerRequest request) throws Exception {
        Map<String, Object> buyer = buyerService.updateBuyer(buyerId, request);
