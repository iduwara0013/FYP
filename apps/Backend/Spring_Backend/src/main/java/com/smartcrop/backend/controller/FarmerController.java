...
public class FarmerController {
    ...
    @PutMapping("/{farmerId}")
    public ResponseEntity<Map<String, Object>> updateFarmer(@PathVariable String farmerId, @Valid @RequestBody FarmerRequest request) throws Exception {
        Map<String, Object> farmer = farmerService.updateFarmer(farmerId, request);
        return farmer == null ? ResponseEntity.notFound().build() : ResponseEntity.ok(farmer);
    }
