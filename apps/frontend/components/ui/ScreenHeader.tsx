...
const styles=StyleSheet.create({wrap:{minHeight:72,paddingHorizontal:16,paddingVertical:12,flexDirection:"row",alignItems:"center",gap:10,borderBottomWidth:1,zIndex:5},back:{width:42,height:42,borderRadius:14,alignItems:"center",justifyContent:"center"},icon:{width:42,height:42,borderRadius:14,alignItems:"center",justifyContent:"center"},copy:{flex:1},title:{fontSize:18,lineHeight:23,fontWeight:"900"},subtitle:{fontSize:11,lineHeight:16,marginTop:1}});
